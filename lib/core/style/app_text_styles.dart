...
class AppTextStyles {
  ...
  static TextStyle get keyDigit =>
      TextStyle(fontFamily: fontMono, fontSize: 22.sp);

  /// Operator key glyph (+ − × ÷). Mono · 24.
  static TextStyle get keyOperator =>
      TextStyle(fontFamily: fontMono, fontSize: 24.sp);
  ...
  static TextStyle get keyFunction =>
      TextStyle(fontFamily: fontMono, fontSize: 20.sp);
